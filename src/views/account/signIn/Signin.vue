  ...
  <ion-page>
    <ion-content class="ion-padding">
      ...
      <ion-list lines="none">
        ...
        <!-- <a router-link="/forgotPassword" class="forgot"></a> -->

        <ion-button expand="block" size="large"> Login </ion-button>
        <div class="social-wrap">
          <p>- OR continue with</p>
          <div class="social-media">
            <a href="#"> <ion-img :src="google">hii</ion-img> </a>
            <a href="#"> <ion-img :src="apple">hii</ion-img> </a>
            <a href="#"> <ion-img :src="facebook">hii</ion-img> </a>
          </div>
          <p>
